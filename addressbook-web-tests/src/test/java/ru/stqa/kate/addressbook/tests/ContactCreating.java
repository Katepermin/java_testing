...
public class ContactCreating {
  ...
  @Test
    ...
    gotoAddNewPage();
    initContactCreation();
    fillContactForm(new ContactData("Adam", "Smith", "Ady", "Apple", "+16190000000", "+16191111111", "adam@gmail.com"));
    submitContactForm();
    returmToContacts();
  }

  private void returmToContacts() {
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("company")).sendKeys(contactData.getWork());
    wd.findElement(By.name("home")).click();
    wd.findElement(By.name("home")).clear();
    wd.findElement(By.name("home")).sendKeys(contactData.getPhoneHome());
    wd.findElement(By.name("mobile")).click();
    wd.findElement(By.name("mobile")).clear();
    wd.findElement(By.name("mobile")).sendKeys(contactData.getPhoneCell());
